...
CBSSettings::CBSSettings(Options& options)
  : Settings(options)
{
  ...
  _globalRenderer = new PhotonRenderer(0, 1000000, 20, lightHemisS);
...
{
  return new CBSSettings(options);
}