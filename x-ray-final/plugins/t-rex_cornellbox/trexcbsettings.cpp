...
TrexCBSettings::TrexCBSettings(Options& options)
  : Settings(options)
{
  ...
  //dynamic_cast<PhotonRenderer*>(_globalRenderer)->debugGlobal(true, .4f, comp);
...
//_____________________________________________________________________________
TrexCBSettings::~TrexCBSettings(void)
{
}
...
{
  return new TrexCBSettings(options);
}