...
#include "trexcbscene.h"
//#include "x-ray_includes.h"


//_____________________________________________________________________________
TrexCBScene::TrexCBScene(const Options& options)
  : Scene(options)
{
}
...
TrexCBScene::add(World& world)
{
  ...
  UnitSampler* uSampler = /*new MidpointS;*/ new StratifiedS(128);
  Emissive* emissive = new Emissive;
  LightShape* lightShape = new Rect(Point(-52.652, 494.973, -73.524),
                                    Vector(84.937, 0, -58.659),
                                    Vector(47.378, 0, 68.602),
                                    Normal(0,-1,0) );
...
{
  return new TrexCBScene(options);
}