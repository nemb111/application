...
AntialiasingSettings::AntialiasingSettings(Options& options)
  : Settings(options)
{
  ...
  //_filter = new BoxFilter3(4, 4);
  //_filter = new BoxedGaussFilter(20, 6);
  //_filter = new GaussFilter(20);
...
//_____________________________________________________________________________
AntialiasingSettings::~AntialiasingSettings(void)
{
}
...
{
  return new AntialiasingSettings(options);
}