...
TrexNormSettings::TrexNormSettings(Options& options)
  : Settings(options)
{
...
//_____________________________________________________________________________
TrexNormSettings::~TrexNormSettings(void)
{
}
...
{
  return new TrexNormSettings(options);
}