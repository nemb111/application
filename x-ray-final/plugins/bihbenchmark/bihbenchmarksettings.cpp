...
#include "bihbenchmarksettings.h"
...
BIHBenchmarkSettings::BIHBenchmarkSettings(Options& options)
  : Settings(options)
{
...
//_____________________________________________________________________________
BIHBenchmarkSettings::~BIHBenchmarkSettings(void)
{
}
...
{
  return new BIHBenchmarkSettings(options);
}